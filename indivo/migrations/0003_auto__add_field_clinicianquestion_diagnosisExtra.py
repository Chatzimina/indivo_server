...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Clinicianquestion.diagnosisExtra'
        db.add_column('indivo_clinicianquestion', 'diagnosisExtra',
                      self.gf('django.db.models.fields.CharField')(max_length=800, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Clinicianquestion.diagnosisExtra'
        db.delete_column('indivo_clinicianquestion', 'diagnosisExtra')
