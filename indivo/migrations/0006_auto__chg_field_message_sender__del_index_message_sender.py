...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('indivo_message', 'sender_id', 'sender')
        # Changing field 'Message.sender'
        db.alter_column('indivo_message', 'sender', self.gf('django.db.models.fields.CharField')(max_length=250))
        # Removing index on 'Message', fields ['sender']
        db.delete_index('indivo_message', ['sender_id'])


    def backwards(self, orm):
        # Adding index on 'Message', fields ['sender']
        db.create_index('indivo_message', ['sender_id'])


        # Renaming column for 'Message.sender' to match new field type.
        db.rename_column('indivo_message', 'sender', 'sender_id')
        # Changing field 'Message.sender'
        db.alter_column('indivo_message', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['indivo.Principal']))
    ...
    models = {
        ...
        'indivo.message': {
            ...
            'sender': ('django.db.models.fields.CharField', [], {'default': "'chrome@apps.indivo.org'", 'max_length': '250'}),
