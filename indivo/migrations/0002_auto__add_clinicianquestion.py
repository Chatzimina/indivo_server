...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Clinicianquestion'
        db.create_table('indivo_clinicianquestion', (
            ('fact_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['indivo.Fact'], unique=True, primary_key=True)),
            ('patientName', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('patientId', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('diagnosisAge', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ...
            ('initialDiagnosis', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('treatmentC', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('treatmentS', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('treatmentR', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('treatmentCI', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('treatmentSI', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('treatmentRI', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('treatmentCD', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('treatmentSD', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('treatmentRD', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('karnovskyIndex', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('expectedOutcome', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('computerSkills', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('computerGames', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('indivo', ['Clinicianquestion'])


    def backwards(self, orm):
        # Deleting model 'Clinicianquestion'
        db.delete_table('indivo_clinicianquestion')
    ...
    models = {
        ...
        'indivo.clinicianquestion': {
            'Meta': {'object_name': 'Clinicianquestion', '_ormbases': ['indivo.Fact']},
            'computerGames': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'computerSkills': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'diagnosis': ('django.db.models.fields.CharField', [], {'max_length': '800', 'null': 'True', 'blank': 'True'}),
            'diagnosisAge': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'expectedOutcome': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
            'gender': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'initialDiagnosis': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'karnovskyIndex': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'patientId': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'patientName': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'treatmentC': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'treatmentCD': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'treatmentCI': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'treatmentR': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'treatmentRD': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'treatmentRI': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'treatmentS': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'treatmentSD': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'treatmentSI': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'indivo.demographics': {
