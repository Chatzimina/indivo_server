...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Message', fields ['account', 'external_identifier', 'sender', 'sender2']
        db.create_unique('indivo_message', ['account_id', 'external_identifier', 'sender_id', 'sender2'])


    def backwards(self, orm):
        # Removing unique constraint on 'Message', fields ['account', 'external_identifier', 'sender', 'sender2']
        db.delete_unique('indivo_message', ['account_id', 'external_identifier', 'sender_id', 'sender2'])
    ...
    models = {
        ...
        'indivo.clinicianquestion': {
            ...
            'diagnosisExtra': ('django.db.models.fields.CharField', [], {'max_length': '800', 'null': 'True', 'blank': 'True'}),
        ...
        'indivo.message': {
            'Meta': {'unique_together': "(('account', 'external_identifier', 'sender', 'sender2'),)", 'object_name': 'Message'},
            ...
            'sender2': ('django.db.models.fields.CharField', [], {'default': "'chrome@apps.indivo.org'", 'max_length': '250'}),
