...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.pilot'
        db.add_column('indivo_account', 'pilot',
                      self.gf('django.db.models.fields.CharField')(max_length=350, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.pilot'
        db.delete_column('indivo_account', 'pilot')
