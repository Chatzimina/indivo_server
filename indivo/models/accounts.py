...
class Account(Principal):
    ...
    cancerDisease = models.CharField(max_length=50,null=True)
    placeOfResidence = models.CharField(max_length=50,null=True)
    sharingPreferences = models.CharField(max_length=50,null=True)    
    role = models.CharField(max_length=50,null=False,default='patient')
    speciality = models.CharField(max_length=350,null=True)
    health_organisation = models.CharField(max_length=350,null=True)
    address_organisation = models.CharField(max_length=350,null=True)
    pilot = models.CharField(max_length=350,null=True)
...
#           conn.autocommit = True
        ...
        try:
           ...
           cursor.execute( "SELECT username FROM public.indivo_accountauthsystem where account_id='"+account_id+"'" )
           conn.commit()
...
class AuthSystem(Object):
    ...
    def CUSTODIX(cls):
        # FIXME: memoize this
        return cls.objects.get_or_create(short_name='system', internal_p=False)[0]
