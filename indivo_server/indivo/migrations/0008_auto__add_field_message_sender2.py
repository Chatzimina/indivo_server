...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.sender2'
        db.add_column('indivo_message', 'sender2',
                      self.gf('django.db.models.fields.CharField')(default='chrome@apps.indivo.org', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.sender2'
        db.delete_column('indivo_message', 'sender2')
