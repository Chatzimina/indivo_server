...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Filedocument.file_base64'
        db.add_column('indivo_filedocument', 'file_base64',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Filedocument.file_base64'
        db.delete_column('indivo_filedocument', 'file_base64')
