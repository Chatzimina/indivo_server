...
{
    "method":"POST",
    "path":"/accounts/newuser",
    "view_func_name":"account_send_newuser",
    "access_doc":"Any admin app.",
    "url_params":{
        },
    "query_opts":{
    ...
    "description":"Email a new user to register in iMC portal",
    "return_desc":":http:statuscode:`200 Success`. Also emails the account with their new secret.",
    "return_ex":'''
<ok/>
''',
...
application/rdf+xml:
    ...
    <rdf:Description rdf:nodeID="_6730841b-05df-445f-8695-ed64197f4e6a">
        <v:family-name>John</v:family-name>
        <rdf:type rdf:resource="http://www.w3.org/2006/vcard/ns#Name"/>
        <v:given-name>Smith</v:given-name>
    </rdf:Description>
...
application/xml:
    ...
    <Models>
        <Model name="Demographics" documentId="44190967-cbaa-43a7-a98c-9f97f094ef2b">
            ...
            <Field name="race"/>
            <Field name="name_given">John</Field>
            <Field name="name_suffix"/>
            <Field name="name_family">Smith</Field>
...
application/xml:
    ...
    <Models>
        <Model name="Demographics" documentId="44190967-cbaa-43a7-a98c-9f97f094ef2b">
            ...
            <Field name="preferred_language">EN</Field>
            <Field name="race"/>
            <Field name="name_given">Smith</Field>
            <Field name="name_suffix"/>
            <Field name="name_family">John</Field>
            <Field name="name_prefix"/>
            <Field name="tel_2_type">h</Field>
            <Field name="tel_2_preferred_p">True</Field>
            <Field name="tel_2_number">800-870-3011</Field>
...
{
    "method":"DELETE",
    "path":"/records/{RECORD_ID}/documents/{DATA_MODEL}/all/carenets/{CARENET_ID}",
    "view_func_name":"carenet_pha_delete",
    "access_doc":"A principal in full control of the carenet's record.",
    "url_params":{
        'RECORD_ID':'The id string associated with the Indivo record',
    ...
    "description":"Unshare all documents from a given carenet.",
    "return_desc":":http:statuscode:`200 Success`, or :http:statuscode:`404` if ``DOCUMENT_ID`` is invalid or if either the passed carenet or document do not belong to the passed record.",
    "return_ex":'''
<ok/>
''',
...
},
{
    "method":"PUT",
    "path":"/records/{RECORD_ID}/documents/{DATA_MODEL}/all/carenets/{CARENET_ID}",
    "view_func_name":"carenet_pha_placement",
    "access_doc":"A principal in full control of the carenet's record.",
    "url_params":{
        'RECORD_ID':'The id string associated with the Indivo record',
        'DATA_MODEL':'DATA MODEL',
...
{
    "method":"GET",
    "path":"/records/{RECORD_ID}/sharescompanion/",
    "view_func_name":"record_shares_companion",
